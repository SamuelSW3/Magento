...
docker cp magento2devbox_web_ea42889ddcd7d558a7954b69ce9e1837:/windows/unison.exe .
docker cp magento2devbox_web_ea42889ddcd7d558a7954b69ce9e1837:/windows/unison-fsmonitor.exe .

FOR /f "delims=" %%A IN ('docker port magento2devbox_web_ea42889ddcd7d558a7954b69ce9e1837 5000') DO SET "CMD_OUTPUT=%%A"
FOR /f "tokens=1,* delims=:" %%A IN ("%CMD_OUTPUT%") DO SET "UNISON_PORT=%%B"

@SET LOCAL_ROOT=C:\xampp\htdocs\magento
